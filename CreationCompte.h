...
namespace ProjetPOO {
	...
	/// </summary>
	public ref class CreationCompte : public System::Windows::Forms::Form
	{
	public:
		CreationCompte(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox4->TextChanged += gcnew System::EventHandler(this, &CreationCompte::textBox4_TextChanged);
			// 
			// label5
			// 
			...
			this->label5->Click += gcnew System::EventHandler(this, &CreationCompte::label5_Click);
			// 
			// CreationCompte
			// 
			...
			this->Name = L"CreationCompte";
			this->Text = L"CreationCompte";
