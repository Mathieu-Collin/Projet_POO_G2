...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(157, 279);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 0;
			this->button1->Text = L"Client";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &PageChoixUtilisateur::button1_Click);
			// 
			// button2
			// 
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(639, 279);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(426, 151);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(70, 22);
			this->textBox1->TabIndex = 4;
			this->textBox1->Text = L"Vous êtes";
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &PageChoixUtilisateur::textBox1_TextChanged);
			// 
			// PageChoixUtilisateur
			// 
