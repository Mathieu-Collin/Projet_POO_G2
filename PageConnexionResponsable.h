...
namespace ProjetPOO {
	...
	/// <summary>
	/// Description résumée de PageConnexionResponsable
	/// </summary>
	public ref class PageConnexionResponsable : public System::Windows::Forms::Form
	{
	public:
		PageConnexionResponsable(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->buttonConnect->Click += gcnew System::EventHandler(this, &PageConnexionResponsable::Connect_Button_Click);
			// 
			// textBoxNom
			// 
			...
			this->labelNom->Click += gcnew System::EventHandler(this, &PageConnexionResponsable::label1_Click);
			// 
			// labelPrenom
			// 
			...
			this->Name = L"PageConnexionResponsable";
			this->Text = L"PageConnexionResponsable";
			this->Load += gcnew System::EventHandler(this, &PageConnexionResponsable::PageResponsable_Load);
...
#pragma endregion
	...
	private: System::Void buttonConnect_Click(System::Object^ sender, System::EventArgs^ e) //vérifie si le responsable existe dans la table Responsable puis vérifie si les champs sont remplie avant de connecter le ma
	{
	}
	...
	private: System::Void Connect_Button_Click(System::Object^ sender, System::EventArgs^ e)// Regarde si l'utilisateur existe et si il existe alors le connecter mais si il n'existe pas, ouvrir une pop up d'erreur
	{
		...
		String^ query = "SELECT * FROM Personnel WHERE nom = @nom AND prenom = @prenom AND MotDePasse = @mdp AND role = @responsable";
		...
		try {
			...
			if (count > 0) {
				...
				PageResponsable^ pageResponsable = gcnew PageResponsable();
				pageResponsable->ShowDialog();
			}
			else {
